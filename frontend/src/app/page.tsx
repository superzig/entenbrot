            ...
            <MaxWidthWrapper className='mb-12 mt-10 flex flex-col sm:mt-20'>
                <div className='flex flex-col justify-start gap-x-36 md:flex-row-reverse'>
                    ...
                    <div>
                        ...
                        <h1 className='text-4xl font-bold md:text-6xl'>
                            Ein{' '}
                            <span className='text-primary'>Algorithmus</span>,
                            der passt!
                        </h1>
                    ...
                    <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
                        <li className="md:flex-1">
                            <div
                                ...
                                <span className="text-sm font-medium text-primary">Schritt 1</span>
                        ...
                        <li className="md:flex-1">
                            <div
                                className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
                                <span className="text-sm font-medium text-primary">Schritt 2</span>
                        ...
                        <li className="md:flex-1">
                            <div
                                className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
                                <span className="text-sm font-medium text-primary">Schritt 3</span>
                ...
                {/* Download documenation section */}
                <div className="position relative">
                    <div className="mx-auto mb-32 sm:mt-32 max-w-5xl text-center">
                        <div className="mb-12 px-6 lg:px-8">
                            <div className="mx-auto mx-w-2xl sm:text-center">
                                <h2 className="mt-2 font-bold text-4xl text-gray-900 sm:text-5xl">
                                    <span className="text-primary">Dokumentation</span> herunterladen
                                </h2>
                                <p className="mt-4 text-lg text-gray-600">
                                    Lies die Dokumentation, um zu erfahren, wie Entenbrot funktioniert.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-center">
                            <Link
                                ...
                                href={'/documenation.pdf'}
                                download='Entenbrot-Dokumentation.pdf'
                                target="_blank"
                            >
                        ...
                        <div aria-hidden="true"
                            ...
                            <div style={{
                                clipPath: "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"
                                 ...
                                 className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#3b82f6] to-[#ffbe3a] opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"></div>
                        </div>
                    </div>
                </div>
            </MaxWidthWrapper>
